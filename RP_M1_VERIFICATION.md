...
3. **Business-logic rewiring through providers**: routes still call the Stripe SDK/Resend directly (working, M0-verified). The provider layer currently powers verification; swapping call sites to capability interfaces is mechanical and next.
